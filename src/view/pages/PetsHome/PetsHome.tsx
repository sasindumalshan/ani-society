import img from '/src/assets/image/Home-img.svg';
import homeAni from '/src/assets/image/homeAni.png'
import petAni from '/src/assets/image/petAni.png'
function PetsHome() {
	return (<>
		<section className="pl-[3rem] pr-[3rem] pt-12 pb-12 mt-12">
			...
			<div className='flex flex-wrap gap-11 justify-center'>
				...
				<div className='relative w-[650px]'>
					...
					<h1 className='text-[95px] font-extrabold text-[#53524D] '>MY<span className='text-[45px] ml-6' >future pet</span></h1>
